 ...
 * Modified By:
 */
public class FayiCleanContent {
    private static Logger LOGGER = LawLogger.getLawLogger(FayiCleanContent.class);
    ...
    public FayiCleanContent(String lawCollection, String cleanCollection) {
        this.lawCollecion = mongoDB.getCollection(lawCollection);
        this.cleanCollection = mongoDB.getCollection(cleanCollection);
    }

    public static void main(String[] args) {
        FayiCleanContent fayiCleanContent = new FayiCleanContent("fayi_clean", "law3");
        fayiCleanContent.addContentHtml();
    }
            ...
            while (cursor.hasNext()) {
                ...
                if (iterablesclean.first() != null) {
                    ...
                    for (String contentpar : contentList) {
                        ...
                        if (contentpar.indexOf("执行日期：") == 0 && !timeless) {
                            timeless = true;
                            continue;
                        }
        ...
        try {
            while (cursor.hasNext()) {
                ...
                if (iterablesclean.first() != null) {
                    ...
                    Elements contentHtml = lawHtmlDocument.select("#articleContnet");
