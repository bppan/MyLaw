...
public class ChinacourtSpider extends LawSpider{
    ...
    public ChinacourtSpider(String indexUrl, int crawHtmlthreadCount){
        super(indexUrl, crawHtmlthreadCount);
    }

    @Override
    public Document getJsoupConnection(String htmlUrl) throws IOException {
        return super.getJsoupConnection(htmlUrl);
    }
...
//    private static Logger LOGGER = LawLogger.getLawLogger(PkulawSpider.PkulawSpider.class);
